...
class SyslogLoggerPluginConfigurator implements \Everon\Logger\Contract\Configurator\PluginConfiguratorInterface
{
    ...
    public const LOGOPTS = 'logopts';

    protected const METADATA = [
        'pluginClass' => [
            'type' => 'string',
            'default' => \Everon\LoggerBasic\Plugin\Syslog\SyslogLoggerPlugin::class,
            'mappingPolicy' => [],
        ...
        'ident' => ['type' => 'string', 'default' => null, 'mappingPolicy' => [], 'mappingPolicyValue' => 'ident'],
        'facility' => [
            'type' => 'int',
            'default' => \LOG_LOCAL0,
            'mappingPolicy' => [],
            'mappingPolicyValue' => 'facility',
        ],
        'logopts' => ['type' => 'int', 'default' => \LOG_PID, 'mappingPolicy' => [], 'mappingPolicyValue' => 'logopts'],
    ];

    protected array $updateMap = [];
    protected ?string $pluginClass = \Everon\LoggerBasic\Plugin\Syslog\SyslogLoggerPlugin::class;
    ...
    public function requireIdent(): string
    {
        ...
        $this->setupDateTimeProperty('ident');
    ...
    public function requireFacility(): int
    {
        ...
        $this->setupDateTimeProperty('facility');
    ...
    public function requireLogopts(): int
    {
        ...
        $this->setupDateTimeProperty('logopts');
