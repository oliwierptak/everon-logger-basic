...
class StreamLoggerPluginConfigurator implements \Everon\Logger\Contract\Configurator\PluginConfiguratorInterface
{
    ...
    protected const METADATA = [
        'pluginClass' => [
            'type' => 'string',
            'default' => \Everon\LoggerBasic\Plugin\Stream\StreamLoggerPlugin::class,
            'mappingPolicy' => [],
    ...
    protected ?string $pluginClass = \Everon\LoggerBasic\Plugin\Stream\StreamLoggerPlugin::class;
