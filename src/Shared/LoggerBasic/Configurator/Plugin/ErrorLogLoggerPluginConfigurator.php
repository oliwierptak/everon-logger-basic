...
class ErrorLogLoggerPluginConfigurator implements \Everon\Logger\Contract\Configurator\PluginConfiguratorInterface
{
    ...
    public const EXPAND_NEWLINES = 'expandNewlines';

    protected const METADATA = [
        'pluginClass' => [
            'type' => 'string',
            'default' => \Everon\LoggerBasic\Plugin\ErrorLog\ErrorLogLoggerPlugin::class,
            'mappingPolicy' => [],
        ...
        'messageType' => [
            ...
            'mappingPolicy' => [],
            'mappingPolicyValue' => 'messageType',
        ],
        'expandNewlines' => [
            'type' => 'bool',
            'default' => false,
            'mappingPolicy' => [],
            'mappingPolicyValue' => 'expandNewlines',
        ],
    ];

    protected array $updateMap = [];
    protected ?string $pluginClass = \Everon\LoggerBasic\Plugin\ErrorLog\ErrorLogLoggerPlugin::class;
    ...
    public function requireMessageType(): int
    {
        ...
        $this->setupDateTimeProperty('messageType');
    ...
    public function requireExpandNewlines(): bool
    {
        ...
        $this->setupDateTimeProperty('expandNewlines');
